...
echo ""
echo "     git remote add origin https://github.com/spm310-ux/cold-email-generator.git"
echo "     git branch -M main"
echo "     git push -u origin main"
echo ""
echo "  If you already added 'origin' before, use instead:"
echo "     git remote set-url origin https://github.com/spm310-ux/cold-email-generator.git"
echo "     git push -u origin main"
echo ""
